...
export const INITIAL_USERS: User[] = [
  ...
  },
  {
    ...
    role: 'operator_unit',
    roleTitle: 'Operator',
    opdId: 'opd-berdasarkan-unit',
    opdName: 'Berdasarkan Unit Kerja',
  },
  {
    id: 'user-validator',
    name: 'Validator',
    ...
    roleTitle: 'Validator',
    opdId: 'opd-spi',
    opdName: 'Satuan Pengawas Internal (SPI)',
  },
  {
    id: 'user-verifikator',
    name: 'Verifikator',
    ...
    opdId: 'opd-timker-ren-eval',
    opdName: 'Timker Perencanaan dan Evaluasi Program',
  },
];
...
export const INITIAL_OPD: OPD[] = [
  {
    ...
    kode: 'DIR.01',
    nama: 'Direktorat Layanan Operasional',
  ...
  },
  {
    ...
    kode: 'DIR.02',
    nama: 'Direktorat Pelayanan Medik & Keperawatan',
  ...
  },
  {
    ...
    kode: 'DIR.03',
    nama: 'Direktorat Perencanaan & Keuangan',
  ...
  },
  {
    ...
    kode: 'DIR.04',
    nama: 'Direktorat SDM, Pendidikan & Penelitian',
  ...
  },
  {
    id: 'opd-komite-ppi',
    kode: 'KOM.01',
    nama: 'Komite Medik & Pengendalian Klinis',
  ...
  },
  {
    id: 'opd-komite-mutu',
    kode: 'KOM.02',
    nama: 'Komite Mutu & Keselamatan Pasien',
  ...
  },
  {
    id: 'opd-spi',
    kode: 'SPI.01',
    nama: 'Satuan Pengawas Internal (SPI)',
  ...
  {
    id: 'opd-timker-ren-eval',
    kode: 'TIMKER.01',
    nama: 'Timker Perencanaan dan Evaluasi Program',
    kepala: 'Ketua Tim Kerja Perencanaan & Evaluasi Program',
    nipKepala: '-',
    email: 'timker.reneval@rsupdjamil.co.id',
    telepon: '(0751) 32373',
  },
  {
    id: 'opd-berdasarkan-unit',
    kode: 'UNIT.00',
    nama: 'Berdasarkan Unit Kerja',
    kepala: 'Pimpinan Masing-Masing Unit Kerja',
    nipKepala: '-',
    email: 'operator@kemkes.go.id',
    telepon: '(0751) 32371',
  },
  {
    ...
    kode: 'LINTAS.01',
    nama: 'Lintas Direktorat Keuangan & SDM Diklit',
  ...
  },
  {
    ...
    kode: 'LINTAS.02',
    nama: 'Lintas Seluruh Direktorat',
  ...
  },
  {
    id: 'opd-medik-mutu',
    kode: 'LINTAS.03',
    nama: 'Lintas Direktorat Medik & Komite Mutu',
  ...
  },
  {
    ...
    kode: 'LINTAS.04',
    nama: 'Lintas Direktorat Keuangan & Medik',
...
const RAW_INDIKATOR_PK: Omit<IndikatorPK, 'tahun' | 'id'>[] = [
  // Sasaran Strategis 1
  {
    ...
    tipeIndikator: 'IKU',
    permasalahan: 'Fluktuasi waktu tunggu pelayanan farmasi rawat jalan dan loket verifikasi kepesertaan pada jam puncak (09.00 - 12.00).',
    rencanaTindakLanjut: 'Implementasi antrean mandiri berbasis QR Code dan akselerasi peracikan obat melalui penambahan personil apoteker jam sibuk.',
    strategi: 'Penyediaan sistem monitoring CSAT berkala tiap unit, fasilitas Fast Track pasien prioritas, dan digitalisasi display antrean poliklinik.',
    linkDakung: 'https://drive.google.com/drive/folders/dakung-csat-rsup-mdjamil-2025',
  },
  ...
  // Sasaran Strategis 2
  {
    ...
    tipeIndikator: 'IKU',
    permasalahan: 'Keterbatasan sarana prasarana canggih di beberapa RSUD jejaring pengampuan wilayah binaan Sumatera Barat dan Riau.',
    rencanaTindakLanjut: 'Melaksanakan workshop klinis on-site, bimbingan teknis proctoring, serta pengusulan DAK fisik alat kesehatan ke Kemenkes RI.',
    strategi: 'Kolaborasi proctoring layanan bedah kardiovaskular dan onkologi secara hybrid (telekonsultasi dan visitasi berkala tim dokter subspesialis).',
    linkDakung: 'https://drive.google.com/drive/folders/dakung-pengampuan-jejaring-kemenkes',
  },
  ...
  // Sasaran Strategis 3
  {
    ...
    tipeIndikator: 'IKU',
    permasalahan: 'Proses pengurusan Ethical Clearance uji klinis multisentris internasional dan penandatanganan Clinical Trial Agreement (CTA) membutuhkan waktu telaah.',
    rencanaTindakLanjut: 'Standardisasi SOP telaah Komite Etik Penelitian secara digital melalui portal SIM-EPK dan pembentukan desk asistensi kemitraan riset.',
    strategi: 'Menjalin kemitraan contract research organization (CRO) global dan farmasi multinasional serta insentif bagi peneliti utama (Principal Investigator).',
    linkDakung: 'https://drive.google.com/drive/folders/dakung-cru-penelitian-2025',
  },
...
export const INITIAL_LHE: LHEEvaluation[] = [
  {
    ...
    ukuranFile: '2.8 MB',
    status: 'Diterbitkan ke Unit Kerja',
